...
question_bank = {
    ...
    "Architect": [
        ...
        {
            "section": "Architecture",
            "question": "Design an end-to-end data platform for reporting (high level)",
            "good": "Mentions ingestion, storage, transformation, serving, governance, monitoring.",
            "red": "Tool listing only; no flow or layers."
        },

        {
            "section": "Architecture",
            "question": "When would you NOT use Medallion architecture?",
            "good": "Mentions small datasets, real-time systems, simplicity trade-offs.",
...

        {
            ...
            "good": "Latency, cost, use case driven decision.",
            "red": "No decision criteria."
        },

        {
            "section": "Architecture",
            "question": "What is Medallion Architecture?",
            "good": "Bronze raw, Silver cleaned, Gold curated; purpose of each layer.",
            "red": "Cannot clearly explain layers or purpose."
        },

        {
            "section": "Architecture",
            "question": "How do you design end-to-end data architecture?",
            "good": "Mentions ingestion, storage, transformation, serving, governance.",
            "red": "Very generic or tool-only answer."
        },

        {
            "section": "Cloud",
            "question": "Compare Fabric, Databricks, Synapse use cases",
            "good": "Explains strengths, when to use each.",
            "red": "Lists tools without comparison."
        },

        {
            "section": "Orchestration",
            "question": "How do you design resilient pipelines?",
            "good": "Retries, idempotency, logging, monitoring.",
            "red": "No failure handling approach."
        },

        {
            "section": "Modeling",
            "question": "Difference between OLTP and OLAP?",
            "good": "Transactional vs analytical systems.",
            "red": "Cannot explain clearly."
        },

        {
            "section": "Power BI",
            "question": "How does Power BI fit into data architecture?",
            "good": "Consumes curated Gold layer for reporting and analytics.",
            "red": "No clarity on integration."
        },

        {
            "section": "Experience",
            "question": "Explain one architecture you designed end-to-end",
            "good": "Clear ownership, trade-offs, tools, challenges.",
...
🚀 {selected_role} Miracle Interview Evaluation
</div>
""", unsafe_allow_html=True)
